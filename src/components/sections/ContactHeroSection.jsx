...
const ContactHeroSection = () => {
    return (
        <section className='pt-40 pb-20 px-20 flex relative'>
            ...
            <div className='flex flex-col justify-center items-center grow'>
                ...
                <h1 className='section-header'>Got <span className='text-green-800'>Questions</span>? <br /> We've Got <span className="text-red-800">Answers</span></h1>
