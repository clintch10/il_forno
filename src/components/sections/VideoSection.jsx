    ...
    <section className='flex px-20 py-20 relative'>
      ...
      <div className='mx-auto container flex flex-col items-center'>
        <div className='flex flex-col items-center mb-10 2xl:mb-15'>
          <h2 className='font-cairo text-center text-gray-800 font-extrabold text-[40px] xl:text-[50px] mb-5 uppercase'>The true <span className='text-green-800'>Italian</span> <span className='text-red-800'>taste</span> and more</h2>
